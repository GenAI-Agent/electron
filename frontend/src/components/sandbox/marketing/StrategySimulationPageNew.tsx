                       ...
                       .map((rec, idx) => (
                         <div key={idx} className="p-4 bg-red-50 rounded-lg border border-red-200">
                           ...
                           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                             <div>
                               <div className="font-medium text-red-700 mb-1">預算分配</div>
                               <div className="text-red-600">NT$ 5,000,000</div>
                               <div className="text-red-600">- 人員培訓: NT$ 1,500,000</div>
                               <div className="text-red-600">- 系統升級: NT$ 2,000,000</div>
                               <div className="text-red-600">- 宣傳材料: NT$ 1,500,000</div>
                             </div>
                             <div>
                               <div className="font-medium text-red-700 mb-1">負責部門</div>
                               <div className="text-red-600">- 行銷部門 (主要)</div>
                               <div className="text-red-600">- 客服部門 (配合)</div>
                               <div className="text-red-600">- IT部門 (支援)</div>
                             </div>
                           </div>
                           
                           <div className="mt-3">
                             <div className="font-medium text-red-700 mb-1">執行時程</div>
                             <div className="text-red-600">第1週: 計畫制定與團隊組建</div>
                             <div className="text-red-600">第2週: 系統評估與需求分析</div>
                             <div className="text-red-600">第3週: 開始實施與培訓</div>
                             <div className="text-red-600">第4週: 效果評估與調整</div>
                           </div>
                     ...
                     {selectedRecord.detailedResults.actionRecommendations
                       ...
                       .map((rec, idx) => (
                         <div key={idx} className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                           ...
                           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                             <div>
                               <div className="font-medium text-orange-700 mb-1">預算分配</div>
                               <div className="text-orange-600">NT$ 15,000,000</div>
                               <div className="text-orange-600">- 市場研究: NT$ 3,000,000</div>
                               <div className="text-orange-600">- 策略制定: NT$ 5,000,000</div>
                               <div className="text-orange-600">- 實施推廣: NT$ 7,000,000</div>
                             </div>
                             <div>
                               <div className="font-medium text-orange-700 mb-1">負責部門</div>
                               <div className="text-orange-600">- 策略部門 (主導)</div>
                               <div className="text-orange-600">- 行銷部門 (執行)</div>
                               <div className="text-orange-600">- 財務部門 (配合)</div>
                             </div>
                           </div>
                           
                           <div className="mt-3">
                             <div className="font-medium text-orange-700 mb-1">執行時程</div>
                             <div className="text-orange-600">第1-2個月: 市場分析與策略規劃</div>
                             <div className="text-orange-600">第3-4個月: 試點實施與效果評估</div>
                             <div className="text-orange-600">第5-6個月: 全面推廣與優化</div>
                           </div>
                     ...
                     {selectedRecord.detailedResults.actionRecommendations
                       ...
                       .map((rec, idx) => (
                         <div key={idx} className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                           ...
                           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                             <div>
                               <div className="font-medium text-blue-700 mb-1">預算分配</div>
                               <div className="text-blue-600">NT$ 30,000,000</div>
                               <div className="text-blue-600">- 品牌建設: NT$ 12,000,000</div>
                               <div className="text-blue-600">- 技術投資: NT$ 10,000,000</div>
                               <div className="text-blue-600">- 人才培養: NT$ 8,000,000</div>
                             </div>
                             <div>
                               <div className="font-medium text-blue-700 mb-1">負責部門</div>
                               <div className="text-blue-600">- 品牌部門 (主導)</div>
                               <div className="text-blue-600">- 研發部門 (配合)</div>
                               <div className="text-blue-600">- 人資部門 (支援)</div>
                             </div>
                           </div>
                           
                           <div className="mt-3">
                             <div className="font-medium text-blue-700 mb-1">執行時程</div>
                             <div className="text-blue-600">第1年: 品牌定位與基礎建設</div>
                             <div className="text-blue-600">第2年: 市場擴張與影響力提升</div>
                             <div className="text-blue-600">第3年: 領導地位確立與維護</div>
                           </div>
