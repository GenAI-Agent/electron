...
from supervisor_agent.tools.browser_control_tools import (
    BROWSER_TOOLS, 
    get_browser_tool, 
    cleanup_all_tools,
    BaseBrowserTool
...
class ToolManager:
    ...
    def get_tools_for_rule(self, rule_name: Optional[str] = None) -> Dict[str, BaseBrowserTool]:
        """獲取指定規則的工具集"""
        tools = {}
    ...
    def activate_tools(self, rule_name: Optional[str] = None) -> Dict[str, BaseBrowserTool]:
        """激活指定規則的工具集"""
